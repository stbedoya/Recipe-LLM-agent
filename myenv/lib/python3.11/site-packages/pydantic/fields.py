...
class FieldInfo(_repr.Representation):
    ...
    def __init__(self, **kwargs: Unpack[_FieldInfoInputs]) -> None:
        ...
        self.metadata = (
            self._collect_metadata(kwargs) + annotation_metadata
        )  # type: ignore
    ...
    def from_annotated_attribute(
        ...
        if isinstance(default, FieldInfo):
            default.annotation, annotation_metadata = (
    ...
    @overload
    def get_default(
        self, *, call_default_factory: Literal[False] = ...
    ) -> Any: ...
        ...
        *,
        ...
        if self.default_factory is None:
            ...
            if self.default_factory_takes_validated_data:
                fac = cast(
                    "Callable[[dict[str, Any]], Any]", self.default_factory
                )
    ...
    def apply_typevars_map(
        ...
        annotation, _ = _typing_extra.try_eval_type(
            self.annotation, globalns, localns
        )
...
class ComputedFieldInfo:
    ...
    title: str | None
    field_title_generator: (
        typing.Callable[[str, ComputedFieldInfo], str] | None
    )
    description: str | None
    deprecated: Deprecated | str | bool | None
    examples: list[Any] | None
...
def _wrapped_property_is_private(
    property_: cached_property | property,
) -> bool:
...
def computed_field(
    *,
    ...
    json_schema_extra: (
        JsonDict | typing.Callable[[JsonDict], None] | None
    ) = None,
    repr: bool = True,
