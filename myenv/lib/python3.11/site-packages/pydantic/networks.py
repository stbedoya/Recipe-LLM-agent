...
class UrlConstraints:
    ...
    def __get_pydantic_core_schema__(
        ...
        for (
            constraint_key,
            constraint_value,
        ) in self.defined_constraints.items():
...
class _BaseUrl:
    ...
    def __init__(self, url: str | _CoreUrl | _BaseUrl) -> None:
        self._url = (
            _build_type_adapter(self.__class__).validate_python(url)._url
        )
...
class _BaseMultiHostUrl:
    ...
    def __init__(
        self, url: str | _CoreMultiHostUrl | _BaseMultiHostUrl
    ) -> None:
        self._url = (
            _build_type_adapter(self.__class__).validate_python(url)._url
        )
...
@lru_cache
def _build_type_adapter(
    cls: type[_BaseUrl | _BaseMultiHostUrl],
) -> TypeAdapter:
