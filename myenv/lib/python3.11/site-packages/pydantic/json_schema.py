...
class GenerateJsonSchema:
    ...
    def build_schema_type_to_method(
        ...
        for key in core_schema_types:
            ...
            try:
                ...
                if (
                    os.environ["PYDANTIC_PRIVATE_ALLOW_UNHANDLED_SCHEMA_TYPES"]
                    == "1"
                ):
                    continue
                raise TypeError(
    ...
    def generate_definitions(
        ...
        self._used = True
        return json_schemas_map, self.sort(
            json_schema["$defs"]
        )  # type: ignore
    ...
    def generate_inner(
        ...
        metadata = cast(
            _core_metadata.CoreMetadata, schema.get("metadata", {})
        )
        ...
        for js_modify_function in metadata.get(
    ...
    def invalid_schema(
        self, schema: core_schema.InvalidSchema
    ) -> JsonSchemaValue:
    ...
    def _update_class_schema(
        ...
        * deprecated
        ...
        docstring = (
            None
            if cls is BaseModel or dataclasses.is_dataclass(cls)
            else cls.__doc__
        )
