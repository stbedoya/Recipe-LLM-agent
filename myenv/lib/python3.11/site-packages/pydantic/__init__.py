...
if typing.TYPE_CHECKING:
    ...
    # this encourages pycharm to import `ValidationError` from here, not
    # pydantic_core
...
__all__ = (
    ...
    # JSON Schema
    "WithJsonSchema",
    # deprecated V1 functional validators, these are imported via
    # `__getattr__` below
    "root_validator",
    "validator",
...
# A mapping of {<member name>: (package, <module name>)} defining dynamic
# imports
