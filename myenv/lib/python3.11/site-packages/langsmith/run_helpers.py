...
_TRACING_ENABLED = contextvars.ContextVar[
    Optional[Union[bool, Literal["local"]]]
...
def tracing_context(
    *,
    ...
    parent: Optional[
        Union[run_trees.RunTree, Mapping, str, Literal[False]]
    ] = None,
...
def traceable(
    ...
    **kwargs: Any,
    ...
    container_input = _ContainerInput(
        ...
        dangerously_allow_filesystem=kwargs.pop(
...
def _is_attachment(param: inspect.Parameter) -> bool:
    return param.annotation == schemas.Attachment or (
        ...
        and any(
            arg == schemas.Attachment for arg in get_args(param.annotation)
        )
    )
...
def _process_iterator(
    ...
    try:
        while True:
            item: T = run_container["context"].run(
                next, generator
