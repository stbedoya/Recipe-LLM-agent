...
_run_vars: WeakKeyDictionary[asyncio.AbstractEventLoop, Any] = (
    WeakKeyDictionary()
)
        ...
        try:
            ...
            if (
                ...
                if self._pending_uncancellations:
                    ...
                    assert (
                        self._parent_scope._pending_uncancellations is not None
                    )
...
if sys.version_info >= (3, 12):
    _eager_task_factory_code: CodeType | None = (
        asyncio.eager_task_factory.__code__
    )
else:
