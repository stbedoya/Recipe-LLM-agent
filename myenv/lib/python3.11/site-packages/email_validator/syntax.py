...
def validate_email_local_part(
    ...
    if DOT_ATOM_TEXT_INTL.match(local):
        ...
        if not allow_smtputf8:
            ...
            # Although the check above should always find something, fall back
...
def check_unsafe_chars(s: str, allow_space: bool = False) -> None:
    ...
    for i, c in enumerate(s):
        ...
        if category[0] in ("L", "N", "P", "S"):
            ...
            # specification that email addresses do not contain line breaks
            # when not quoted.
            bad_chars.add(c)
        elif category[0] == "C":
            ...
            # to the Unicode specification in the future, reject all other
            # categories.
            bad_chars.add(c)
    if bad_chars:
        raise EmailSyntaxError(
