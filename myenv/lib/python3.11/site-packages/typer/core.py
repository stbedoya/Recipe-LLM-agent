...
class TyperArgument(click.core.Argument):
    ...
    def get_help_record(self, ctx: click.Context) -> Optional[Tuple[str, str]]:
        ...
        if self.show_envvar:
            envvar = self.envvar
            # allow_from_autoenv is currently not supported in Typer for CLI
            # Arguments
        ...
        # Typer override:
        # Extracted to _extract_default_help_str() to allow re-using it in
        # rich_utils
        ...
        if show_default_is_str or (
            ...
            # Typer override:
            # Extracted to _get_default_string() to allow re-using it in
            # rich_utils
...
class TyperOption(click.core.Option):
    ...
    def get_help_record(self, ctx: click.Context) -> Optional[Tuple[str, str]]:
        ...
        # Ref:
        # https://typer.tiangolo.com/tutorial/parameter-types/bool/#only-names-for-false
        if self.hidden:
            return None
