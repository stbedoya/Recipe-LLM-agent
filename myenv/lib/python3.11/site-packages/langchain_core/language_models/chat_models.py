...
class BaseChatModel(BaseLanguageModel[BaseMessage], ABC):
    ...
    def stream(
        ...
        **kwargs: Any,
        ...
        if not self._should_stream(
            ...
            structured_output_format = kwargs.pop(
                ...
                try:
                    structured_output_format_dict = {
                        "structured_output_format": {
                            "kwargs": structured_output_format.get(
                                "kwargs", {}
                            ),
            ...
            if generation is None:
                ...
                run_manager.on_llm_error(
                    err, response=LLMResult(generations=[])
                )
                raise err
    ...
    def _generate_with_cache(
        ...
        **kwargs: Any,
        ...
        # astream_events() or astream_log(). Bail out if _stream not
        # implemented
    ...
    async def _agenerate_with_cache(
        ...
        **kwargs: Any,
        ...
        # If stream is not explicitly set, check if implicitly requested by
        # astream_events() or astream_log(). Bail out if _astream not
        # implemented
        if self._should_stream(
            async_api=True,
            run_manager=run_manager,
