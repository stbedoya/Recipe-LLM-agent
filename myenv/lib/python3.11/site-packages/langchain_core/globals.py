...
def set_verbose(value: bool) -> None:
    ...
    try:
        ...
        # The user called the correct (non-deprecated) code path and shouldn't
        # get warnings.
...
def get_verbose() -> bool:
    ...
    try:
        ...
        with warnings.catch_warnings():
            ...
            # directing them to use `set_verbose()` when they import
            # `langchain.verbose`.
...
def get_debug() -> bool:
    ...
    try:
        ...
        with warnings.catch_warnings():
            ...
            # directing them to use `set_debug()` when they import
            # `langchain.debug`.
