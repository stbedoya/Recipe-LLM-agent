...
if PYDANTIC_MAJOR_VERSION == 1:
    ...
    # Union type needs to be last assignment to PydanticBaseModel to make mypy
    # happy.
...
def _remap_field_definitions(
    ...
    for key, value in field_definitions.items():
        if key.startswith("_") or key in _RESERVED_NAMES:
            # Let's add a prefix to avoid colliding with internal pydantic
            # fields
...
def create_model_v2(
    ...
    *,
    ...
    field_definitions = cast(
        dict[str, Any], field_definitions or {}
    ...
    if root:
        ...
        try:
            ...
            # something in the arguments into _create_root_model_cached is not
            # hashable
