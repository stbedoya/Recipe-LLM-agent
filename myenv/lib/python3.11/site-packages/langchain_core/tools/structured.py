...
class StructuredTool(BaseTool):
    ...
    async def ainvoke(
        ...
        **kwargs: Any,
        ...
        if not self.coroutine:
            # If the tool does not implement async, fall back to default
            # implementation
    ...
    async def _arun(
        ...
        **kwargs: Any,
        ...
        # implementation which is expected to delegate to _run on a separate
        # thread.
    ...
    def from_function(
        ...
        **kwargs: Any,
        ...
        if description_ is None and args_schema:
            if isinstance(args_schema, type) and is_basemodel_subclass(
                args_schema
            ):
