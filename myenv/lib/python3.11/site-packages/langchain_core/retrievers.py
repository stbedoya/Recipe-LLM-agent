...
class BaseRetriever(
    ...
    def __init_subclass__(cls, **kwargs: Any) -> None:
        ...
        if (
            ...
            == BaseRetriever._aget_relevant_documents
        ):
            # we need to tolerate no run_manager in _aget_relevant_documents
            # signature
        ...
        # If a V1 retriever broke the interface and expects additional
        # arguments
