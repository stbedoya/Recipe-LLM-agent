...
try:
    ...
    async def connect_socks_proxy(
        ...
        **kwargs: Any,
        ...
        try:
            return await socks_proxy.connect(
...
def prepare_connect_request(
    ...
    host = build_host(
        ws_uri.host, ws_uri.port, ws_uri.secure, always_include_port=True
    )
    headers = Headers()
...
class HTTPProxyConnection(asyncio.Protocol):
    ...
    def connection_made(self, transport: asyncio.BaseTransport) -> None:
        ...
        self.transport.write(
            prepare_connect_request(
                self.proxy, self.ws_uri, self.user_agent_header
            )
        )
