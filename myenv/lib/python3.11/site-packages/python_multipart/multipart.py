...
def parse_options_header(
    ...
    # If we are passed bytes, we assume that it conforms to WSGI, encoding in
    # latin-1.
...
class MultipartParser(BaseParser):
    ...
    def _internal_write(self, data: bytes, length: int) -> int:
        ...
        def data_callback(
            ...
            # can be certain is not a boundary, leaving only a partial boundary
            # match.
            if remaining:
                ...
                # a LF.
                    ...
                    if flags & FLAG_PART_BOUNDARY:
                        ...
                        if c == LF:
                            ...
                            # We have identified a boundary, callback for any
                            # data before it.
...
class FormParser:
    ...
    def __init__(
        ...
        parser: (
            OctetStreamParser | MultipartParser | QuerystringParser | None
        ) = None
