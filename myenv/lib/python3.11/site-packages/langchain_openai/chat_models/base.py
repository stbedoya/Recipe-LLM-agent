...
def _convert_dict_to_message(_dict: Mapping[str, Any]) -> BaseMessage:
    ...
    if role == "user":
        ...
        return ChatMessage(
            content=_dict.get("content", ""), role=role, id=id_
...
def _convert_message_to_dict(message: BaseMessage) -> dict:
    ...
    if isinstance(message, ChatMessage):
        ...
        if message.tool_calls or message.invalid_tool_calls:
            ...
            pass
        # If tool calls present, content null value should be None not empty
        # string.
...
def _convert_delta_to_message_chunk(
    ...
    if role == "user" or default_class == HumanMessageChunk:
        ...
        role in ("system", "developer") or default_class == SystemMessageChunk
    ):
        if role == "developer":
...
class BaseChatOpenAI(BaseChatModel):
    ...
    def _convert_chunk_to_generation_chunk(
        ...
        generation_info = (
            {**base_generation_info} if base_generation_info else {}
        )
    ...
    def _stream(
        ...
        **kwargs: Any,
        ...
        if (
            hasattr(response, "get_final_completion")
    ...
    async def _astream(
        ...
        **kwargs: Any,
        ...
        if "response_format" in payload:
            ...
            if self.include_response_headers:
                raw_response = (
                    await self.async_client.with_raw_response.create(**payload)
                )
                response = raw_response.parse()
                base_generation_info = {"headers": dict(raw_response.headers)}
            else:
        ...
        **kwargs: Any,
        ...
        if tool_choice:
            if isinstance(tool_choice, str):
                ...
                # We support 'any' since other models use this instead of
                # 'required'.
                if tool_choice == "any":
